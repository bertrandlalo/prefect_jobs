...
# TODO: schema xdf_validation should avoid using this uggly trick. When refactoring and migrating pipeline_hdf to iguazu,
# TODO: we should diagnostic and repair the events based on the schema version.

# This is a protector against corrupted events.
valid_sequences_keys = ['space-stress_game-tutorial_0', 'space-stress_outro_0',
       'physio-sonification_respiration-feedback_0', 'intro_calibration_0',
       'common_respiration-calibration_data-accumulation_0',
       'session_sequence_0', 'physio-sonification_sequence_0',
       'space-stress_game_0', 'space-stress_game_1',
       'physio-sonification_playground_0',
       'physio-sonification_cardiac-feedback_0',
       'cardiac-coherence_coherence-feedback_0',
       'physio-sonification_survey_0', 'space-stress_sequence_0',
       'cardiac-coherence_score_0', 'baseline_sequence_0',
       'baseline_sequence_1', 'baseline_sequence_2', 'baseline_sequence_3',
       'space-stress_game_enemy-wave_0', 'space-stress_game_enemy-wave_1',
       'space-stress_game_enemy-wave_2', 'space-stress_game_enemy-wave_3',
       'space-stress_game_enemy-wave_4', 'space-stress_game_enemy-wave_5',
       'baseline_eyes-opened_0', 'baseline_eyes-opened_1',
       'baseline_eyes-opened_2', 'baseline_eyes-opened_3',
       'space-stress_breath-tutorial_0', 'intro_disclaimer_0',
       'lobby_sequence_0', 'lobby_sequence_1', 'lobby_sequence_2',
       'physio-sonification_coherence-feedback_0', 'space-stress_survey_0',
       'space-stress_survey_1', 'intro_omi-logo_0',
       'cardiac-coherence_sequence_0', 'intro_sequence_0',
       'cardiac-coherence_survey_0', 'cardiac-coherence_survey_1',
       'space-stress_graph_0', 'space-stress_graph_1', 'space-stress_intro_0',
       'baseline_eyes-closed_0', 'cardiac-coherence_data-accumulation_0']

def report_sequences(events, sequences=None):
    ''' Reports the beginning and ends of sequences from a VR session.
    ...
    >>> report = report_sequences(events, sequences=None)
    >>> report
